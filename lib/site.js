...
export const site = {
  name: 'Maison Helleborus',
  tagline: 'Créations florales & scénographie d\'événements',
  baseline: 'L\'art floral des instants précieux',
...
export const nav = [
  ...
  { href: '/decors-permanents/', label: 'Décors floraux permanents' },
